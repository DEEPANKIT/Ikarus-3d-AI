#!/usr/bin/env python3
"""
Comprehensive System Test - Simple Version
"""
...
def test_complete_system():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"SUCCESS: Products endpoint working - {len(products)} products")
        else:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if data.get('status') == 'success':
                ...
                print(f"SUCCESS: Analytics working - {analytics_data.get('total_products', 'N/A')} products")
            else:
                print("FAILED: Analytics returned error status")
        else:
            print(f"FAILED: Analytics failed: {response.status_code}")
    except Exception as e:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if len(description) > 20:
                ...
                print("WARNING: AI description generation returned short description")
        else:
            print(f"FAILED: AI description failed: {response.status_code}")
    except Exception as e:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"SUCCESS: Recommendations endpoint working - {len(recommendations)} results")
            ...
            if len(recommendations) > 0:
                ...
                print("WARNING: No recommendations returned - check service initialization")
        else:
            print(f"FAILED: Recommendations failed: {response.status_code}")
